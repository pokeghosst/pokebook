...
const config = {
	...
	loaders: [
		...
		{ locale: 'en', key: 'errors', loader: async () => (await import('./en/errors.json')).default },
		{
			locale: 'en',
			key: 'hotkeys',
			loader: async () => (await import('./en/hotkeys.json')).default
		},
		...
		{ locale: 'es', key: 'errors', loader: async () => (await import('./es/errors.json')).default },
		{
			locale: 'es',
			key: 'hotkeys',
			loader: async () => (await import('./es/hotkeys.json')).default
		},
		...
		{ locale: 'ru', key: 'errors', loader: async () => (await import('./ru/errors.json')).default },
		{
			locale: 'ru',
			key: 'hotkeys',
			loader: async () => (await import('./ru/hotkeys.json')).default
		},
		...
		{ locale: 'ru', key: 'toasts', loader: async () => (await import('./ru/toasts.json')).default },
		{
			locale: 'ru',
			key: 'workspace',
			loader: async () => (await import('./ru/workspace.json')).default
		}
	]
} satisfies Config;
